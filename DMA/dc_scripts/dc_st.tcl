...
#     }
    ...
    # read_saif -auto_map_names -input SAIF/rtl_saif_backward_${DESIGN_NAME}.saif -instance_name map_tb/dut -verbose
...
###
read_saif -auto_map_names -input $SAIF_FILE -instance_name $TB_DUT -verbose
